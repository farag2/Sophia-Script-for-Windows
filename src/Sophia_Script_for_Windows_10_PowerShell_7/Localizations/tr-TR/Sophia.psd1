...
UnsupportedISE                            = \nKomut dosyası, Windows PowerShell ISE üzerinden çalıştırmayı desteklemiyor
Win10TweakerWarning                       = \nMuhtemelen işletim sisteminize Win 10 Tweaker arka kapısı yoluyla bulaştı
SycnexWarning                             = \nWindows işletim sistemi kararlılığı, Sycnex'in Windows10Debloater PowerShell betiği kullanılarak tehlikeye atılmış olabilir. Önleyici olarak, Windows'u yeniden yükleyin
Fs00Warning                               = \nWindows işletim sistemi kararlılığı, "Windows 10 Bloat Remover and Tweaker" betiği kullanılarak tehlikeye atılmış olabilir. Önleyici olarak, Windows'u yeniden yükleyin
