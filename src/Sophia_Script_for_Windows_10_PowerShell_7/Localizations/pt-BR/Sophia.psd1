...
BitLockerWarning                          = A criptografia do BitLocker está em andamento. Conclua a configuração da unidade do BitLocker e tente novamente.
...
DownloadNotification                      = O {0} está sendo baixado...
InstallNotification                       = O {0} está sendo instalado... 
OneDriveUsageWarning                      = Faça logout da conta do OneDrive antes de desinstalar o aplicativo.
