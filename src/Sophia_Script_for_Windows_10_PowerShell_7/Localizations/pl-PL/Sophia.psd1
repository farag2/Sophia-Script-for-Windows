...
UnsupportedISE                            = \nSkrypt nie może być uruchamiany w Windows PowerShell ISE
Win10TweakerWarning                       = \nPrawdopodobnie twój system operacyjny został zainfekowany przez backdoora pochodzącego z Win 10 Tweaker
SycnexWarning                             = \nStabilność systemu Windows mogła zostać naruszona przez użycie skryptu Windows10Debloater od Sycnex. Zapobiegawczo zainstaluj ponownie Windows
Fs00Warning                               = \nStabilność systemu Windows mogła zostać naruszona przez użycie "Windows 10 Bloat Remover and Tweaker". Zapobiegawczo zainstaluj ponownie Windows
