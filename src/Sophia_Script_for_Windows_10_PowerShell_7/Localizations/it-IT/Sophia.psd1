...
GeoIdNotSupported                         = La funzione "{0}" è applicabile solo per la Russia e la Bielorussia.
...
BitLockerAutomaticEncryption              = L'unità è crittografata, anche se BitLocker è disattivato. Se necessario, decrittografare l'unità.
