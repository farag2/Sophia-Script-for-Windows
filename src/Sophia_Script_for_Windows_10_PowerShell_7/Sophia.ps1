...
$Host.UI.RawUI.WindowTitle = "Sophia Script for Windows 10 v5.14.7 (PowerShell 7) | Made with $([char]::ConvertFromUtf32(0x1F497)) of Windows | $([char]0x00A9) farag & Inestic, 2014$([char]0x2013)2023"
