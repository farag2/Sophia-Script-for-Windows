...
WrongSophiaScriptVersion                  = O script é compatível apenas com o Windows 10 22H2. Você está usando o {0} {1}. Execute o script correto de acordo com a edição do Windows.
UpdateWindowsBuild                        = O script é compatível com o Windows 10 22H2 {0}.{1} e versões posteriores. Você está usando o {2} {3} {4}.{5}. Execute o Windows Update e tente novamente.
...
HEVCInstallingApplication                 = O Extensões de vídeo HEVC do fabricante do dispositivo está sendo instalado...
