...
DownloadNotification                      = {0} est en cours de téléchargement...
InstallNotification                       = {0} est en cours d'installation...
OneDriveUsageWarning                      = Veuillez vous déconnecter de votre compte OneDrive avant de désinstaller l'application.
