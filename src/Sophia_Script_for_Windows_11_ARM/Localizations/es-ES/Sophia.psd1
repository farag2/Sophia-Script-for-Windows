...
CopilotPCSupport                          = Tu CPU no tiene una NPU integrada, por lo que no es compatible con ninguna función de IA de Windows. No es necesario desactivar nada mediante políticas de GPO. Se han eliminado la función Recall y la aplicación Copilot.
