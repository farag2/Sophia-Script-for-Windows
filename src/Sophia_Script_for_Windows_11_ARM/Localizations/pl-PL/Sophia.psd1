...
CopilotPCSupport                          = Twój procesor nie ma wbudowanego procesora NPU, więc nie obsługuje żadnych funkcji sztucznej inteligencji systemu Windows. Nie ma potrzeby wyłączania niczego za pomocą zasad GPO. Funkcja Recall i aplikacja Copilot zostały usunięte.
