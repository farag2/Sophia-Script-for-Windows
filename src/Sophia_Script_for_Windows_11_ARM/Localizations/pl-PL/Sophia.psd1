...
GeoIdNotSupported                         = Funkcja "{0}" ma zastosowanie wyłącznie w Rosji i na Białorusi.
...
BitLockerAutomaticEncryption              = Dysk jest zaszyfrowany, mimo że funkcja BitLocker jest wyłączona. W razie potrzeby odszyfruj dysk.
