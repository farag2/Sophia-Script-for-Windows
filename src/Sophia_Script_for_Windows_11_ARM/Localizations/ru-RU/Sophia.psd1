...
UnsupportedArchitecture                   = Вы используете ЦП с архитектурой "{0}". Скрипт поддерживает ЦП с архитектурой Arm. Скачайте и запустите версию скрипта для вашей архитектуры.
...
OneDriveWarning                           = Пожалуйста, выйдите из учетной записи OneDrive перед удалением приложения.
