...
CopilotPCSupport                          = La tua CPU non dispone di una NPU integrata, quindi non supporta alcuna funzione AI di Windows. Non è necessario disabilitare nulla utilizzando i criteri GPO. La funzione Recall e l'applicazione Copilot sono state rimosse.
