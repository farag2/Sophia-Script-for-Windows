...
function InitialActions
{
	...
	$Host.UI.RawUI.WindowTitle = "Sophia Script for Windows 10 LTSC 2021 v6.3.0 | Made with $([System.Char]::ConvertFromUtf32(0x1F497)) of Windows | $([System.Char]0x00A9) Team Sophia, 2014$([System.Char]0x2013)2026"
	...
	switch ((Get-CimInstance -ClassName CIM_OperatingSystem).BuildNumber)
	{
		{$_ -ne 19044}
		{
			...
			Write-Information -MessageData "" -InformationAction Continue
			Write-Warning -Message ($Localization.UpdateWindowsBuild -f 19044, $LatestSupportedMinorBuild, $Windows_Long, $DisplayVersion, $CurrentBuild, $UBR)
			Write-Information -MessageData "" -InformationAction Continue
