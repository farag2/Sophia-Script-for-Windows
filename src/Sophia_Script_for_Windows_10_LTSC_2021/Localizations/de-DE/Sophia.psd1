...
UnsupportedOSBuild                        = Das Skript unterstützt nur Windows 10 Enterprise LTSC 2021. Sie verwenden Windows {0} {1}. Aktualisieren Sie Ihr Windows und versuchen Sie es erneut.
...
GeoIdNotSupported                         = Die Funktion "{0}" ist nur für Russland und Weißrussland verfügbar.
ThirdPartyArchiverInstalled               = Ein Archivierungsprogramm eines Drittanbieters ist installiert.
BitLockerAutomaticEncryption              = Das Laufwerk ist verschlüsselt, obwohl BitLocker deaktiviert ist. Entschlüsseln Sie Ihr Laufwerk bei Bedarf.
