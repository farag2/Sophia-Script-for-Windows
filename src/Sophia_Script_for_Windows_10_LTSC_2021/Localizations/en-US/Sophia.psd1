...
WrongSophiaScriptVersion                  = Script supports only Windows 10 Enterprise LTSC 2021. You're using {0} {1}. Run correct script based on Windows edition.
UpdateWindowsBuild                        = You're using Windows 10 Enterprise LTSC 2021 {0}.{1}. Supported builds are Windows 10 Enterprise LTSC 2021 {0}.{2} and higher. Run Windows Update and try again.
