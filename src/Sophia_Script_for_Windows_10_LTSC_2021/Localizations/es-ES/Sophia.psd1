...
GeoIdNotSupported                         = La función {0}" solo es aplicable en Rusia y Bielorrusia.
ThirdPartyArchiverInstalled               = Se ha instalado un archivador de terceros.
BitLockerAutomaticEncryption              = La unidad está cifrada, aunque BitLocker está desactivado. Descifra la unidad si es necesario.
