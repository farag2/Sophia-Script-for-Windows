...
UnsupportedISE                            = \nEl script no es compatible con la ejecución a través de Windows PowerShell ISE
Win10TweakerWarning                       = \nProbablemente su sistema operativo fue infectado a través del backdoor Win 10 Tweaker
SycnexWarning                             = \nLa estabilidad del sistema operativo Windows puede haberse visto comprometida al utilizar el script PowerShell Windows10Debloater de Sycnex. De forma preventiva, reinstale Windows
Fs00Warning                               = \nLa estabilidad del sistema operativo Windows puede haberse visto comprometida al utilizar el "Windows 10 Bloat Remover and Tweaker". De forma preventiva, reinstale Windows
