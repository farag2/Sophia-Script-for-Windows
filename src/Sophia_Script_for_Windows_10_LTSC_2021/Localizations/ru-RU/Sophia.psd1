...
UnsupportedOSBuild                        = Скрипт поддерживает только Windows 10 Enterprise LTSC 2021. Вы используете {0} {1}. Обновите Windows и попробуйте заново.
...
UpdateWarning                             = Вы используете Windows 10 {0}.{1}. Поддерживаемые сборки: Windows 10 {0}.{2} и выше. Запустите обновление Windows и попробуйте заново.
...
HostsWarning                              = В файле {0} обнаружены сторонние записи. Они могут блокировать соединение с ресурсами, используемыми в работе скрипта. Хотите продолжить?
Bin                                       = В папке "{0}" отсутствуют файлы. Пожалуйста, перекачайте архив.
RebootPending                             = Компьютер ожидает перезагрузки.
BitLockerWarning                          = Выполняется шифрование BitLocker, или BitLocker отключен, но в то же время диск зашифрован. Завершите настройку BitLocker для диска и попробуйте заново.
