...
BitLockerInOperation                      = Le chiffrement BitLocker est en cours. Terminez la configuration du lecteur BitLocker et réessayez.
...
GeoIdNotSupported                         = La fonction "{0} " s'applique uniquement à la Russie et à la Biélorussie.
ThirdPartyArchiverInstalled               = Un programme d'archivage tiers est installé.
BitLockerAutomaticEncryption              = Le disque est chiffré, bien que BitLocker soit désactivé. Décryptez votre disque si nécessaire.
