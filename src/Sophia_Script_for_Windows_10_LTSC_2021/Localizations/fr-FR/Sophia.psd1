...
UnsupportedISE                            = \nLe script ne supporte pas l'exécution via Windows PowerShell ISE
Win10TweakerWarning                       = \nVotre système d'exploitation a probablement été infecté par la porte dérobée Win 10 Tweaker
SycnexWarning                             = \nLa stabilité de l'OS Windows peut avoir été compromise par l'utilisation du script PowerShell Windows10Debloater de Sycnex. De manière préventive, réinstallez Windows
Fs00Warning                               = \nLa stabilité de l'OS Windows peut avoir été compromise par l'utilisation du "Windows 10 Bloat Remover and Tweaker". De manière préventive, réinstallez Windows
