...
BitLockerWarning                          = Le chiffrement BitLocker est en cours, ou BitLocker est désactivé, mais le lecteur est tout de même chiffré. Terminez la configuration BitLocker du lecteur et réessayez.
