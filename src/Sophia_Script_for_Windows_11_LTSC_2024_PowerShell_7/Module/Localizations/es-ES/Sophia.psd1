...
UpdateWindowsBuild                        = El script es compatible con Windows 11 Enterprise LTSC 2024 {0}.{1} y versiones posteriores. Estás utilizando {2} {3} {4}.{5}. Ejecuta Windows Update e inténtalo de nuevo.
