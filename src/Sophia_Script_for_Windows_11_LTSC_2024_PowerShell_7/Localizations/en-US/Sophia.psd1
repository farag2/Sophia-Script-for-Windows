...
WrongSophiaScriptVersion                  = Script supports only Windows 11 Enterprise LTSC 2024. You're using {0} {1}. Run correct script based on Windows edition.
UpdateWindowsBuild                        = You're using Windows 11 Enterprise LTSC 2024 {0}.{1}. Supported builds are Windows 11 Enterprise LTSC 2024 {0}.{2} and higher. Run Windows Update and try again.
