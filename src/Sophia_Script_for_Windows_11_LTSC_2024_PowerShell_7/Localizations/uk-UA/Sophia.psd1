...
WrongSophiaScriptVersion                  = Скрипт підтримує тільки Windows 11 Enterprise LTSC 2024. Ви використовуєте {0} {1}. Запустіть скрипт відповідно до вашої версії Windows.
UpdateWindowsBuild                        = Ви використовуєте Windows 11 Enterprise LTSC 2024 {0}.{1}. Підтримувані збірки: Windows 11 Enterprise LTSC 2024 {0}.{2} і вище. Запустіть оновлення Windows і спробуйте ще раз.
