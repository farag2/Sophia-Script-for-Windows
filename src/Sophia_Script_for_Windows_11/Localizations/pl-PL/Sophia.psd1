...
UnsupportedOSBuild                        = Skrypt obsługuje system Windows 11 23H2 i nowsze wersje. Twoim systemem operacyjnym jest {0}.
...
ThankfulToastTitle                        = Dziękujemy za korzystanie ze Sophia Script
DonateToastButton                         = Podarować
'@
