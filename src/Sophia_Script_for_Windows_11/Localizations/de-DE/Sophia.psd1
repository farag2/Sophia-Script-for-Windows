...
CopilotPCSupport                          = Ihre CPU verfügt über keine integrierte NPU, daher unterstützt sie keine Windows-KI-Funktionen. Es ist nicht erforderlich, etwas mithilfe von GPO-Richtlinien zu deaktivieren. Die Recall-Funktion und die Copilot-Anwendung wurden entfernt.
