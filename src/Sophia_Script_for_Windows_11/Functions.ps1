...
$Host.UI.RawUI.WindowTitle = "Sophia Script for Windows 11 v6.5.5 | Made with $([System.Char]::ConvertFromUtf32(0x1F497)) of Windows | $([System.Char]0x00A9) farag & Inestic, 2014$([System.Char]0x2013)2023"
