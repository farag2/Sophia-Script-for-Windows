...
$Host.UI.RawUI.WindowTitle = "Sophia Script for Windows 11 v6.4.3 | Made with $([char]::ConvertFromUtf32(0x1F497)) of Windows | $([char]0x00A9) farag & Inestic, 2014$([char]0x2013)2023"
