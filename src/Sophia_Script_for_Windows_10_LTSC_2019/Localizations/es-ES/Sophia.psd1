...
UnsupportedOSBuild                        = El script sólo es compatible con Windows 10 Enterprise LTSC 2019. Su sistema operativo es {0}. Actualiza tu Windows e inténtalo de nuevo.
