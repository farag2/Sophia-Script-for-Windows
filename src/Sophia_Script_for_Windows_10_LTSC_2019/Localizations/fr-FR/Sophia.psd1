...
UnsupportedOSBuild                        = Le script ne supporte que Windows 10 Enterprise LTSC 2019. Votre système d'exploitation est {0}.
...
ThankfulToastTitle                        = Merci d'utiliser Sophia Script
DonateToastButton                         = Faire un don
'@
