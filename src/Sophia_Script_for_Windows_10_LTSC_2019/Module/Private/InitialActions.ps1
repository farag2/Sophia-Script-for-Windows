...
function InitialActions
{
	...
	$Host.UI.RawUI.WindowTitle = "Sophia Script for Windows 10 LTSC 2019 v6.3.0 | Made with $([System.Char]::ConvertFromUtf32(0x1F497)) of Windows | $([System.Char]0x00A9) Team Sophia, 2014$([System.Char]0x2013)2026"
	...
	{
		Write-Information -MessageData "" -InformationAction Continue
		Write-Warning -Message $Localization.UnsupportedWindowsBitness
		Write-Information -MessageData "" -InformationAction Continue
	...
	{
		Write-Information -MessageData "" -InformationAction Continue
		Write-Warning -Message (($Localization.UWPComponentsMissing -f "MicrosoftWindows.Client.CBS"), $Localization.ReinstallWindows -join " ")
		Write-Information -MessageData "" -InformationAction Continue
		Write-Verbose -Message "https://massgrave.dev/genuine-installation-media" -Verbose
		Write-Information -MessageData "" -InformationAction Continue
	...
	try
	{
		...
		$LatestSupportedMinorBuild = (Invoke-RestMethod @Parameters).Windows_10_LTSC_2019
	}
	catch [System.Net.WebException]
	{
		# https://learn.microsoft.com/en-us/windows/release-health/release-information
		$LatestSupportedMinorBuild = 9121
	...
	switch ((Get-CimInstance -ClassName CIM_OperatingSystem).BuildNumber)
	{
		{$_ -ne 17763}
		{
			...
			Write-Information -MessageData "" -InformationAction Continue
			Write-Warning -Message ($Localization.UpdateWindowsBuild -f 17763, $LatestSupportedMinorBuild, $Windows_Long, $DisplayVersion, $CurrentBuild, $UBR)
			Write-Information -MessageData "" -InformationAction Continue
