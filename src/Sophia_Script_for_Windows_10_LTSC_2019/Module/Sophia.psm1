...
function Checks
{
	...
	if (-not ([System.AppDomain]::CurrentDomain.GetAssemblies() | Where-Object -FilterScript {$_.Location -eq "$PSScriptRoot\..\bin\PolicyFileEditor\PolFileEditor.dll"}))
	{
	...
	switch (((Get-CimInstance -ClassName Win32_OperatingSystem).BuildNumber -eq 17763) -and ((Get-WindowsEdition -Online).Edition -eq "EnterpriseS"))
	{
		$true
		{
