...
GeoIdNotSupported                         = "{0}" işlevi yalnızca Rusya ve Beyaz Rusya için geçerlidir.
...
BitLockerAutomaticEncryption              = BitLocker kapalı olmasına rağmen sürücü şifrelenmiştir. Gerekirse sürücünüzün şifresini çözün.
