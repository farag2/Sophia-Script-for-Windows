...
BitLockerWarning                          = La crittografia BitLocker è in corso. Completa la configurazione dell'unità BitLocker e riprova.
...
DownloadNotification                      = {0} è in fase di download...
InstallNotification                       = {0} è in fase di installazione...
OneDriveUsageWarning                      = Esci dall'account OneDrive prima di disinstallare l'applicazione.
