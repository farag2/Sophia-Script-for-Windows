...
UnsupportedArchitecture                   = You're using "{0}" based CPU architecture. This script supports Arm architecture based CPU only. Download and run script version for your architecture.
...
PowerShellImportFailed                    = Importing modules from PowerShell 5.1 failed. Please close PowerShell 7 console and rerun the script again.
...
WrongSophiaScriptVersion                  = Script supports Windows 11 25H2 and higher. You're using {0} {1}. Run correct script based on Windows edition.
UpdateWindowsTerminal                     = Windows Terminal version is lower than 1.24. Please update it in the Microsoft Store and try again.
UpdateWindowsBuild                        = Script supports Windows 11 25H2 {0}.{1} build and higher. You're using {2} {3} {4}.{5}. Run Windows Update and try again.
AskQuestion                               = In case you have a question, raise issue on GitHub or ask the community.
...
CopilotPCSupport                          = Your PC does not have a built-in AI accelerator (NPU), so there's no Windows AI related functions support. No need to disable anything using Windows policies. Recall function and Copilot application will only be removed.
UWPAppsTitle                              = UWP Apps
UninstallUWPForAll                        = For all users
NoUWPAppsFound                            = No UWP apps to uninstall.
WDDMVersionUnsupported                    = Supported WDDM version is 2.7 and higher. Current WDDM version is {0}.
...
ScheduledTaskCreatedNotification          = Scheduled task "Sophia\\{0}" was created.
