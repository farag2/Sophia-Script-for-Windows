...
UpdateWarning                             = \n您的Windows 11构建: {0}.{1}。支持的构建: 22621.1344和更高版本。运行Windows Update并再次尝试
UnsupportedLanguageMode                   = \nPowerShell会话在有限的语言模式下运行
LoggedInUserNotAdmin                      = \n登录的用户没有管理员的权利
UnsupportedPowerShell                     = \n你想通过PowerShell {0}.{1}运行脚本。在适当的PowerShell版本中运行该脚本
UnsupportedISE                            = \n该脚本不支持通过Windows PowerShell ISE运行
Win10TweakerWarning                       = \n可能你的操作系统是通过"Win 10 Tweaker"后门感染的
SycnexWarning                             = \n使用Sycnex的Windows10Debloater PowerShell脚本，Windows操作系统的稳定性可能已经受到影响。预防性地，重新安装整个操作系统
Fs00Warning                               = \n使用"Windows 10 Bloat Remover and Tweaker"可能会影响 Windows 稳定性。 预防性地，重新安装 Windows
