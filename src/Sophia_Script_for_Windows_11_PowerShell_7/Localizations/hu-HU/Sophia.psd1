...
CopilotPCSupport                          = A CPU-ja nem rendelkezik beépített NPU-val, ezért nem támogatja a Windows AI funkciókat. Nincs szükség semmilyen GPO-házirend letiltására. A Recall funkció és a Copilot alkalmazás eltávolításra került.
