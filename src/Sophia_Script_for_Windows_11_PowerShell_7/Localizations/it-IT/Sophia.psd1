...
UnsupportedOSBuild                        = Lo script supporta Windows 11 24H2 e versioni successive. Il vostro sistema operativo è {0}. Aggiornare Windows e riprovare.
...
UpdateWarning                             = La tua build di Windows 11 {0}.{1} non è supportata. Build supportate: {2} e successive. Eseguire Windows Update e riprovare.
