...
UnsupportedISE                            = \nLo script non supporta l'esecuzione tramite Windows PowerShell ISE
Win10TweakerWarning                       = \nProbabilmente il tuo sistema operativo è stato infettato tramite una backdoor in Win 10 Tweaker
SycnexWarning                             = \nLa stabilità del sistema operativo Windows potrebbe essere stata compromessa dall'utilizzo dello script PowerShell Windows10Debloater di Sycnex. È consigliato reinstallare il Windows
Fs00Warning                               = \nLa stabilità del sistema operativo Windows potrebbe essere stata compromessa dall'utilizzo dello "Windows 10 Bloat Remover and Tweaker". È consigliato reinstallare il Windows
