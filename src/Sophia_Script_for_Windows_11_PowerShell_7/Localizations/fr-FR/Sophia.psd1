...
CopilotPCSupport                          = Votre processeur ne dispose pas d'un NPU intégré, il ne prend donc en charge aucune fonction IA Windows. Il n'est pas nécessaire de désactiver quoi que ce soit à l'aide des stratégies GPO. La fonction Recall et l'application Copilot ont été supprimées.
