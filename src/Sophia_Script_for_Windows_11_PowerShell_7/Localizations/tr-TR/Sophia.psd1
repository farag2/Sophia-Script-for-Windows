...
UnsupportedOSBuild                        = Komut dosyası Windows 11 22H2+'yı destekler.
UpdateWarning                             = Windows 11 yapınız: {0}.{1}. Desteklenen yapılar: 22621.1992+. Windows Update'i çalıştırın ve tekrar deneyin.
