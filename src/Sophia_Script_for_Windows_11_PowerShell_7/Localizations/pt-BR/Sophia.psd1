...
CopilotPCSupport                          = Sua CPU não possui NPU integrada, portanto, não suporta nenhuma função de IA do Windows. Não é necessário desativar nada usando políticas GPO. A função Recall e o aplicativo Copilot foram removidos.
