...
GeoIdNotSupported                         = Функция "{0}" применима только для России и Беларуси.
...
BitLockerAutomaticEncryption              = Диск зашифрован, хотя BitLocker отключен. При необходимости расшифруйте диск.
