...
GeoIdNotSupported                         = Function "{0}" is applicable for Russia and Belarus only.
...
BitLockerAutomaticEncryption              = Drive is encrypted, although BitLocker is turned off. Decrypt your drive if needed.
