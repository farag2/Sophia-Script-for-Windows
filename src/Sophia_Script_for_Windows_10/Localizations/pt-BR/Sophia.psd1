...
GeoIdNotSupported                         = A função "{0}" é aplicável apenas à Rússia e à Bielorrússia.
...
BitLockerAutomaticEncryption              = A unidade está criptografada, embora o BitLocker esteja desativado. Descriptografe a unidade, se necessário.
