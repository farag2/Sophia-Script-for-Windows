...
UnsupportedISE                            = \nO guião não suporta a execução através do Windows PowerShell ISE
Win10TweakerWarning                       = \nProbabilmente il tuo sistema operativo è stato infettato tramite la backdoor Win 10 Tweaker
SycnexWarning                             = \nA estabilidade do sistema operacional Windows pode ter sido comprometida pela utilização do script Windows10Debloater PowerShell da Sycnex. Preventivamente, reinstale todo o Windows
Fs00Warning                               = \nA estabilidade do sistema operacional Windows pode ter sido comprometida pela utilização do "Windows 10 Bloat Remover and Tweaker". Preventivamente, reinstale todo o Windows
