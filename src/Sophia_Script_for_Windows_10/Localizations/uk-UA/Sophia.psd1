...
BitLockerInOperation                      = Виконується шифрування BitLocker. Завершіть налаштування BitLocker для диска та спробуйте ще раз.
...
GeoIdNotSupported                         = Функція "{0}" застосовується тільки для Росії та Білорусі.
...
BitLockerAutomaticEncryption              = Диск зашифрований, хоча BitLocker вимкнено. За необхідності розшифруйте диск.
