...
GeoIdNotSupported                         = A "{0}" funkció csak Oroszországban és Fehéroroszországban alkalmazható.
...
BitLockerAutomaticEncryption              = A meghajtó titkosítva van, bár a BitLocker ki van kapcsolva. Szükség esetén titkosítsa vissza a meghajtót.
