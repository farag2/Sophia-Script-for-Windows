...
WrongSophiaScriptVersion                  = A szkript kizárólag a Windows 10 22H2 verziót támogatja. {0} {1}-et használsz. A Windows-verziónak megfelelő szkriptet futtassa.
UpdateWindowsBuild                        = A szkript támogatja a Windows 10 22H2 {0}.{1} és újabb verzióit. Ön jelenleg a {2} {3} {4}.{5} verziót használja. Indítsa el a Windows Update szolgáltatást, majd próbálja meg újra.
...
HEVCInstallingApplication                 = A HEVC videokiterjesztések az eszköz gyártójától telepítése folyamatban van...
