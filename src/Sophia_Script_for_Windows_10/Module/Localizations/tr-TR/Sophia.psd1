...
UpdateWindowsBuild                        = Bu komut dosyası, Windows 10 22H2 {0}.{1} ve üzeri sürümleri desteklemektedir. Şu anda {2} {3} {4}.{5} sürümünü kullanıyorsunuz. Windows Update'i çalıştırın ve tekrar deneyin.
