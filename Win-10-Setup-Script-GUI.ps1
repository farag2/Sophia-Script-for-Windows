        ...
        <Grid>
            ...
            <ScrollViewer Grid.Row="3" VerticalScrollBarVisibility="Auto" HorizontalScrollBarVisibility="Disabled">
                ...
                <StackPanel Orientation="Vertical" VerticalAlignment="Top">
                    <TextBlock Text="Privacy &amp; Telemetry Settings" FontSize="16" VerticalAlignment="Center" HorizontalAlignment="Left" Margin="10 5 0 10"/>
                    <Grid HorizontalAlignment="Left" Margin="0 5 0 5">
                        ...
                        <TextBlock Name="TexBlockPrivacy0" Text="Change Windows Feedback frequency to &quot;Never&quot;" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                            <TextBlock.Style>
