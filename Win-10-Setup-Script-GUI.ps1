...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Windows 10 Setup Script" MinHeight="710" MinWidth="660" Height="905" Width="1830" FontFamily="Sergio UI"
                ...
                <StackPanel Orientation="Horizontal" >
                    <StackPanel Orientation="Vertical" VerticalAlignment="Top">
                        ...
                        <Border Name="BorderPrivacy" BorderBrush="#DADADA" BorderThickness="1 0 1 1" Margin="10 0 10 0" Height="43" Background="#FFFFFF">
                            <StackPanel Orientation="Horizontal">
                                <Viewbox Name="IconPrivacy" Width="24" Height="24" HorizontalAlignment="Center" VerticalAlignment="Center" Margin="10 0 0 3">
                                    <Canvas Width="24" Height="24">
                                        <Path Data="M18.15,4.94C17.77,4.91 17.37,5 17,5.2L8.35,10.2C7.39,10.76 7.07,12 7.62,12.94L9.12,15.53C9.67,16.5 10.89,16.82 11.85,16.27L13.65,15.23C13.92,15.69 14.32,16.06 14.81,16.27V18.04C14.81,19.13 15.7,20 16.81,20H22V18.04H16.81V16.27C17.72,15.87 18.31,14.97 18.31,14C18.31,13.54 18.19,13.11 17.97,12.73L20.5,11.27C21.47,10.71 21.8,9.5 21.24,8.53L19.74,5.94C19.4,5.34 18.79,5 18.15,4.94M6.22,13.17L2,13.87L2.75,15.17L4.75,18.63L5.5,19.93L8.22,16.63L6.22,13.17Z" Fill="Black" />
                                    </Canvas>
                                </Viewbox>
                                <TextBlock Name="HeaderPrivacy" Text="Privacy &amp; Telemetry Settings" FontSize="16" VerticalAlignment="Center" HorizontalAlignment="Left" Margin="10 0 10 0"/>
                            </StackPanel>
                        </Border>
                        ...
                        <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" Margin="{Binding ElementName=BorderPrivacy, Path=Margin}" Style="{StaticResource BorderHoverStyle}">
                            <StackPanel Orientation="Horizontal" Margin="5">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="TexBlockSystem29" Text="Set location of the &quot;Desktop&quot;, &quot;Documents&quot; &quot;Downloads&quot; &quot;Music&quot;, &quot;Pictures&quot; and &quot;Videos&quot;" Margin="65 2 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                    ...
                    <StackPanel Orientation="Vertical" VerticalAlignment="Top">
                        ...
                        <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" 
                            ...
                            <StackPanel Orientation="Horizontal">
                                <Viewbox Width="{Binding ElementName=IconPrivacy, Path=Width}" Height="{Binding ElementName=IconPrivacy, Path=Height}" HorizontalAlignment="{Binding ElementName=IconPrivacy,Path=HorizontalAlignment}" VerticalAlignment="{Binding ElementName=IconPrivacy,Path=VerticalAlignment}" Margin="{Binding ElementName=IconPrivacy,Path=Margin}">
                                    <Canvas Width="24" Height="24">
                                        <Path Data="M21,11C21,16.55 17.16,21.74 12,23C6.84,21.74 3,16.55 3,11V5L12,1L21,5V11M12,21C15.75,20 19,15.54 19,11.22V6.3L12,3.18V21Z" Fill="Black" />
                                    </Canvas>
                                </Viewbox>
                        ...
                        <StackPanel Orientation="Vertical" VerticalAlignment="Top">
                            <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" 
                                ...
                                <StackPanel Orientation="Horizontal">
                                    <Viewbox Width="{Binding ElementName=IconPrivacy, Path=Width}" Height="{Binding ElementName=IconPrivacy, Path=Height}" HorizontalAlignment="{Binding ElementName=IconPrivacy,Path=HorizontalAlignment}" VerticalAlignment="{Binding ElementName=IconPrivacy,Path=VerticalAlignment}" Margin="{Binding ElementName=IconPrivacy,Path=Margin}">
                                        <Canvas Width="24" Height="24">
                                            <Path Data="M2.74,10.81C3.83,-1.36 22.5,-1.36 21.2,13.56H8.61C8.61,17.85 14.42,19.21 19.54,16.31V20.53C13.25,23.88 5,21.43 5,14.09C5,8.58 9.97,6.81 9.97,6.81C9.97,6.81 8.58,8.58 8.54,10.05H15.7C15.7,2.93 5.9,5.57 2.74,10.81Z" Fill="Black" />
                                        </Canvas>
                                    </Viewbox>
                            ...
                            <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" Margin="{Binding ElementName=BorderPrivacy, Path=Margin}" Style="{StaticResource BorderHoverStyle}">
                                <StackPanel Orientation="Horizontal" Margin="5">
                                    <Grid HorizontalAlignment="Left">
                                        ...
                                        <TextBlock Name="TexBlockEdge0" Text="Do not allow Microsoft Edge to pre-launch at Windows startup, when the system is idle, and each time Microsoft Edge is closed" Margin="65 2 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                            <TextBlock.Style>
                                                <Style TargetType="{x:Type TextBlock}">
                                                    <Style.Triggers>
                            ...
                            <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" Margin="{Binding ElementName=BorderPrivacy, Path=Margin}" Style="{StaticResource BorderHoverStyle}">
                                <StackPanel Orientation="Horizontal" Margin="5">
                                    <Grid HorizontalAlignment="Left">
                                        ...
                                        <TextBlock Name="TexBlockEdge1" Text="Do not allow Microsoft Edge to start and load the Start and New Tab page at Windows startup and each time Microsoft Edge is closed" Margin="65 2 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                            <TextBlock.Style>
                                                <Style TargetType="{x:Type TextBlock}">
                                                    <Style.Triggers>
                        ...
                        <StackPanel Orientation="Vertical" VerticalAlignment="Top">
                            <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" 
                                ...
                                <StackPanel Orientation="Horizontal">
                                    <Viewbox Width="{Binding ElementName=IconPrivacy, Path=Width}" Height="{Binding ElementName=IconPrivacy, Path=Height}" HorizontalAlignment="{Binding ElementName=IconPrivacy,Path=HorizontalAlignment}" VerticalAlignment="{Binding ElementName=IconPrivacy,Path=VerticalAlignment}" Margin="{Binding ElementName=IconPrivacy,Path=Margin}">
                                        <Canvas Width="24" Height="24">
                                            <Path Data="M19,19H5V8H19M19,3H18V1H16V3H8V1H6V3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3M16.53,11.06L15.47,10L10.59,14.88L8.47,12.76L7.41,13.82L10.59,17L16.53,11.06Z" Fill="Black" />
                                        </Canvas>
                                    </Viewbox>
                            ...
                            <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" Margin="{Binding ElementName=BorderPrivacy, Path=Margin}" Style="{StaticResource BorderHoverStyle}">
                                <StackPanel Orientation="Horizontal" Margin="5">
                                    <Grid HorizontalAlignment="Left">
                                        ...
                                        <TextBlock Name="TexBlockTasks0" Text="Create scheduled task with the &quot;%TEMP%&quot; folder cleanup in Task Scheduler. The task runs every 62 days" Margin="65 2 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                            <TextBlock.Style>
                                                <Style TargetType="{x:Type TextBlock}">
                                                    <Style.Triggers>
                            ...
                            <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" Margin="{Binding ElementName=BorderPrivacy, Path=Margin}" Style="{StaticResource BorderHoverStyle}">
                                <StackPanel Orientation="Horizontal" Margin="5">
                                    <Grid HorizontalAlignment="Left">
                                        ...
                                        <TextBlock Name="TexBlockTasks1" Text="Create task to clean out the &quot;%SystemRoot%\SoftwareDistribution\Download&quot; folder in Task Scheduler.&#x0a;The task runs on Thursdays every 4 weeks" Margin="65 2 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                            <TextBlock.Style>
                                                <Style TargetType="{x:Type TextBlock}">
                                                    <Style.Triggers>
                            ...
                            <Border BorderBrush="{Binding ElementName=BorderPrivacy, Path=BorderBrush}" BorderThickness="{Binding ElementName=BorderPrivacy, Path=BorderThickness}" Margin="{Binding ElementName=BorderPrivacy, Path=Margin}" Style="{StaticResource BorderHoverStyle}">
                                <StackPanel Orientation="Horizontal" Margin="5">
                                    <Grid HorizontalAlignment="Left">
                                        ...
                                        <TextBlock Name="TexBlockTasks2" Text="Create scheduled task with the disk cleanup tool in Task Scheduler. The task runs every 90 days" Margin="65 2 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                            <TextBlock.Style>
                                                <Style TargetType="{x:Type TextBlock}">
                                                    <Style.Triggers>
