...
OneDriveNotEmptyFolder                    = La carpeta "{0}" no está vacía. Eliminarlo manualmente
OneDriveFileSyncShell64dllBlocked         = "{0}" está bloqueado. Eliminarlo manualmente
OneDriveInstalling                        = OneDrive se está instalando...
OneDriveDownloading                       = Descargando OneDrive... ~33 MB
ClearFolder                               = Eliminar todos los archivos en la carpeta "{0}"?
FilesBlocked                              = Los siguientes archivos están siendo bloqueados por la Parte aplicaciones de terceros. Eliminarlos manualmente y continuar
TempNotEmpty                              = La carpeta "{0}" no está vacía. Desactivarla manualmente
