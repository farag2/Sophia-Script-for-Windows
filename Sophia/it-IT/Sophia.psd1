...
OneDriveFileSyncShell64dllBlocked      = "{0}" è bloccato. Eliminarla manualmente
OneDriveInstalling                     = OneDrive sta installando ...
OneDriveDownloading                    = Download di OneDrive... ~33 MB
ClearFolder                            = Elimina tutti i file nella cartella "OneDrive"
FilesBlocked                           = I seguenti file vengono bloccati da app di terze parti. Rimuovili manualmente e continua
TempNotEmpty                           = La cartella Sono rimasti alcuni file nella cartella "Value". Spostarli manualmente in una nuova posizione. non è vuota. Eliminarla manualmente e riprovare
...
DesktopDriveSelect                     = Seleziona l'unità all'interno della radice della quale verrà creata la cartella Dekstop
DocumentsDriveSelect                   = Seleziona l'unità all'interno della radice della quale verrà creata la cartella Documenti
DownloadsDriveSelect                   = Seleziona l'unità all'interno della radice della quale verrà creata la cartella Download
MusicDriveSelect                       = Seleziona l'unità all'interno della radice della quale verrà creata la cartella Musica
PicturesDriveSelect                    = Seleziona l'unità all'interno della radice della quale verrà creata la cartella Immagini
...
DesktopFolderSelect                    = Seleziona una cartella per la cartella Desktop
DocumentsFolderSelect                  = Seleziona una cartella per la cartella Documenti
DownloadsFolderSelect                  = Seleziona una cartella per la cartella Download
MusicFolderSelect                      = Seleziona una cartella per la cartella Musica
PicturesFolderSelect                   = Seleziona una cartella per la cartella Immagini
VideosFolderSelect                     = Seleziona una cartella per la cartella Video
...
syspinDownloading                      = Scaricamento di syspin... ~20 KB
