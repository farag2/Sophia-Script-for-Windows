...
# SetTempPath
LOCALAPPDATANotEmptyFolder = "$env:LOCALAPPDATA\\Temp 不是一个空文件夹.请手动删除并重试"
...
# Desktop
DesktopChangeFolderRequest = 是否要更改桌面文件夹位置?
...
DesktopSkipped = 已跳过
# Documents
DocumentsChangeFolderRequest = 是否要更改文档文件夹位置?
...
# Downloads
DownloadsChangeFolderRequest = 是否要更改下载文件夹位置?
...
# Music
MusicChangeFolderRequest = 是否要更改音乐文件夹位置?
...
MusicSkipped = 已跳过
# Pictures
PicturesChangeFolderRequest = 是否要更改图片文件夹位置?
...
PicturesSkipped = 已跳过
# Videos
VideosChangeFolderRequest = 是否要更改视频文件夹位置?
