...
$headerEng = "Context Menu", "Microsoft Defender", "Microsoft Edge", "Windows Game Recording", "OneDrive", "Privacy & Telemetry", "Start Menu", "System", "Task Scheduler", "UI & Personalization","", "UWP Apps"
...
"Make the ""Open"", ""Print"", ""Edit"" context menu items available,`nwhen more than 15 selected",
...
"Do not allow Microsoft Edge to start and load the Start and New Tab page`nat Windows startup and each time Microsoft Edge is closed",
"Do not allow Microsoft Edge to pre-launch at Windows startup,`nwhen the system is idle, and each time Microsoft Edge is closed",
...
"Do not let apps on other devices open and message apps on this device,`nand vice versa",
"Do not allow apps to use advertising ID",
"Do not use sign-in info to automatically finish setting up device after`nan update or restart",
...
"Create a task in the Task Scheduler to clear the`n""%SystemRoot%\SoftwareDistribution\Download folder""",
...
"Turn on access to mapped drives from app running with elevated`npermissions with Admin Approval Mode enabled",
...
"Set location of the ""Desktop"", ""Documents"", ""Downloads"", ""Music"",`n""Pictures"", and ""Videos""",
...
"Turn on automatic backup the system registry to the`n""%SystemRoot%\System32\config\RegBack folder""",
"Turn off ""The Windows Filtering Platform has blocked a connection"" message`nin ""Windows Logs\Security""",
...
"Turn on automatically save my restartable apps when sign out`nand restart them after sign in",
...
"Добавить ""Запуск от имени другого пользователя"" в контекстное меню`nдля .exe файлов",
...
"Удалить пункт ""Изменить с помощью приложения ""Фотографии""""`nиз контекстного меню",
...
"Сделать доступными элементы контекстного меню ""Открыть"",`n""Изменить"" и ""Печать"" при выделении более 15 элементов",
"Отключить поиск программ в Microsoft Store при открытии`nдиалога ""Открыть с помощью""",
"Отключить Windows Defender SmartScreen в Microsoft Edge",
"Не разрешать Edge запускать и загружать страницу при загрузке Windows`nи каждый раз при закрытии Edge",
"Не разрешать предварительный запуск Edge при загрузке Windows,`nкогда система простаивает, и каждый раз при закрытии Edge",
"Отключить создание ярлыка Edge на рабочем столе для каждого`nпрофиля пользователя пользователя",
...
"Скрыть уведомление Защитника Windows об использовании аккаунта`nMicrosoft",
"Скрыть уведомление Защитника Windows об отключенном фильтре`nSmartScreen для Microsoft Edge",
"Удалить OneDrive",
"Отключить службу ""Функциональные возможности для подключенных`nпользователей и телеметрия""",
"Отключить пользовательские службы",
"Отключить сборщик SQMLogger при следующем запуске ПК",
"Установить уровень отправляемых диагностических сведений на`n""Базовый""",
"Отключить отчеты об ошибках Windows",
"Изменить частоту формирования отзывов на ""Никогда""",
"Отключить задачи диагностического отслеживания",
"Не предлагать персонализированные возможности, основанные на`nвыбранном параметре диагностических данных",
"Не разрешать приложениям на других устройствах запускать приложения`nи отправлять сообщения на этом устройстве и наоборот",
"Не разрешать приложениям использовать идентификатор рекламы",
"Не использовать данные для входа для автоматического завершения`nнастройки устройства после перезапуска или обновления",
"Не позволять веб-сайтам предоставлять местную информацию за счет`nдоступа к списку языков",
"Показывать советы, подсказки и рекомендации по использованию`nWindows",
"Не показывать рекомендации в меню ""Пуск""",
"Не показывать рекомендуемое содержание в ""Параметрах""",
"Отключить автоматическую установку рекомендованных приложений",
"Не разрешать Windows отслеживать запуски приложений для улучшения`nменю ""Пуск"" и результатов поиска",
"Создать задачу в Планировщике задач по очистке обновлений Windows",
"Создать задачу в Планировщике задач по очистке папки`n""%SystemRoot%\SoftwareDistribution\Download""",
"Создать задачу в Планировщике задач по очистке папки ""%TEMP%""",
"Не показывать недавно добавленные приложения в меню ""Пуск""",
"Запускать ярлык к командной строке в меню ""Пуск"" от имени`nАдминистратора",
"Добавить ярлык старого формата для ""Устройства и принтеры"" в меню ""Пуск""",
"Импорт настроенного макета меню ""Пуск"" из предварительно`nсохраненного .reg-файла",
...
"Отключить использование режима одобрения администратором для`nвстроенной учетной записи администратора",
"Включить доступ к сетевым дискам при включенном режиме одобрения`nадминистратором при доступе из программ, запущенных с повышенными`nправами",
...
"Запретить стандартным приложениям работать в фоновом режиме,`nкроме следующих...",
"Установить схему управления питания для !!!",
"Использовать последнюю установленную версию .NET для всех`nприложений",
"Запретить отключение Ethernet-адаптера для экономии энергии",
"Установить метод ввода по умолчанию на английский язык",
"Включить Windows Sandbox",
"Переопределить расположение папок ""Рабочий стол"", ""Документы"",`n""Загрузки"", ""Музыка"", ""Изображения"", ""Видео""",
"Автоматически запускать средства устранения неполадок, а затем`nуведомлять",
"Установить параметры производительности графики для отдельных`nприложений на ""Высокая производительность""",
"Запускать окна с папками в отдельном процессе",
"Отключить и удалить зарезервированное хранилище после следующей`nустановки обновлений",
"Включить автоматическое создание копии реестра в папку`n""%SystemRoot%\System32\config\RegBack""",
"Отключить в ""Журналах Windows\Безопасность"" сообщение`n""Платформа фильтрации IP-пакетов Windows разрешила подключение""",
...
"Автоматически сохранять мои перезапускаемые приложения при выходе`nиз системы и перезапустить их после выхода",
...
"Скрыть папку ""Объемные объекты"" из ""Этот компьютер""`nи на панели быстрого доступа",
"Не показывать недавно используемые папки на панели быстрого доступа",
"Не показывать недавно использовавшиеся файлы на панели быстрого`nдоступа",
"Отключить отображение вкладки ""Предыдущие версии"" в свойствах`nфайлов и папок",
...
"Показывать уведомление, когда компьютеру требуется перезагрузка`nдля завершения обновления",
"Нe дoбaвлять ""- яpлык"" для coздaвaeмыx яpлыкoв",
"Использовать кнопку PRINT SCREEN, чтобы запустить функцию создания`nфрагмента экрана",
"Автоматически изменять период активности для этого устройства на`nоснове действий",
...
<Window
    ...
    <Grid Name="GridWindow">
        ...
        <Canvas Grid.Row="0" Background="#E4E4E4">
            ...
            <TextBlock Name="TextBlock_Category" Text="" FontSize="20" Canvas.Left="60" Canvas.Top="14" />
        ...
        <Grid Grid.Row="1" RenderTransformOrigin="0.54,0.504">
            ...
            <StackPanel Name="PanelToggle_UserInfo" Grid.Column="1" Width="450" VerticalAlignment="Center" HorizontalAlignment="Center" Visibility="Collapsed">
                <Border Name="UserInfo_Border" Height="48" Width="48" RenderTransformOrigin="0.5,0.5" Margin="0 5 0 5" Visibility="Collapsed" >
                    ...
                    <Border.Style>
                        <Style TargetType="Border">
                            <Style.Triggers>
                                <DataTrigger Binding="{Binding ElementName=UserInfo_Border, Path=IsVisible}" Value="True">
                                    <DataTrigger.EnterActions>
                                        <BeginStoryboard>
                                            <Storyboard>
                                                <DoubleAnimation Storyboard.TargetProperty="(Border.RenderTransform).(RotateTransform.Angle)" From="0" To="360" Duration="0:0:6" RepeatBehavior="Forever"/>
                                            </Storyboard>
                                        </BeginStoryboard>
                                    </DataTrigger.EnterActions>
                                </DataTrigger>
                ...
                <TextBlock Name="UserInfo_TextBlock" Text="" FontWeight="Bold" Foreground="#3F51B5" Margin="0 5 0 5" TextWrapping="Wrap" HorizontalAlignment="Center"/>
            </StackPanel>
            ...
            <Canvas Name="HamburgerMenu" Width="50" Background="#3F51B5" Grid.Column="0">
                ...
                <StackPanel Name="Button_Hamburger_Privacy" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="0">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_Privacy" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_Privacy, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_Privacy" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_UI" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="55">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_Ui" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_UI, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_UI" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_OneDrive" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="110">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_OneDrive" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_OneDrive, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_OneDrive" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_System" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="165">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_System" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_System, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_System" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_StartMenu" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="220">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_StartMenu" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_StartMenu, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_StartMenu" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_Edge" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="275">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_Edge" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_Edge, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_Edge" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_Uwp" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="330">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_Uwp" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_Uwp, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_Uwp" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_Game" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="385">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_Game" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_Game, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_Game" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_Tasks" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="440">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_Tasks" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_Tasks, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_Tasks" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_Defender" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="495">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_Defender" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_Defender, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_Defender" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_ContextMenu" Style="{StaticResource PanelHamburgerMenu}" Canvas.Top="550">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_ContextMenu" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_ContextMenu, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_ContextMenu" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_ChangeLanguage" Style="{StaticResource PanelHamburgerMenu}" Canvas.Bottom="55">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_ChangeLanguage" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_ChangeLanguage, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger__ChangeLanguage" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="Button_Hamburger_GitHub" Style="{StaticResource PanelHamburgerMenu}" Canvas.Bottom="0">
                    <StackPanel.Triggers>
                        <EventTrigger RoutedEvent="MouseDown">
                            <EventTrigger.Actions>
                                <BeginStoryboard>
                    ...
                    <DockPanel Name="Container_GitHub" Width="{Binding ElementName=HamburgerMenu, Path=Width}">
                                    ...
                                    <Path.Style>
                                        <Style TargetType="Path">
                                            <Style.Triggers>
                                                ...
                                                <DataTrigger Binding="{Binding ElementName=Button_Hamburger_GitHub, Path=IsMouseOver}" Value="False">
                                                    <Setter Property="Opacity" Value="0.5"/>
                                                </DataTrigger>
                                            </Style.Triggers>
                                        </Style>
                        ...
                        <TextBlock Name="Textblock_Hamburger_GitHub" Text="">
                            <TextBlock.Style>
                                <Style TargetType="TextBlock">
                                    <Setter Property="VerticalAlignment" Value="Center"/>
                                    <Setter Property="Foreground" Value="#FFFFFF"/>
                ...
                <StackPanel Name="TogglePanels">
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_30" Uid="30" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_31" Uid="31" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_32" Uid="32" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_33" Uid="33" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_34" Uid="34" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_35" Uid="35" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_36" Uid="36" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_37" Uid="37" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_38" Uid="38" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_39" Uid="39" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_40" Uid="40" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_41" Uid="41" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_42" Uid="42" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_43" Uid="43" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_44" Uid="44" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_45" Uid="45" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Privacy_46" Uid="46" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                    ...
                    <StackPanel Name="PanelToggle_Ui" Visibility="Collapsed">
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    <ToggleButton Name="Toggle_UI_1098" Uid="1098" Style="{StaticResource ToggleSwitchLeftStyle}" IsChecked="False"/>
                                    <TextBlock Name="Text_UI_98" Uid="98" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                                                    <DataTrigger Binding="{Binding ElementName=Toggle_UI_1098, Path=IsChecked}" Value="True">
                                                        <Setter Property="Foreground" Value="#3F51B5"/>
                                                    </DataTrigger>
                                                </Style.Triggers>
                                            </Style>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_99" Uid="99" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_100" Uid="100" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_101" Uid="101" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_102" Uid="102" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_103" Uid="103" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_104" Uid="104" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_105" Uid="105" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_106" Uid="106" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_107" Uid="107" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_108" Uid="108" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_109" Uid="109" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_110" Uid="110" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_111" Uid="111" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_112" Uid="112" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_113" Uid="113" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_114" Uid="114" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_115" Uid="115" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_116" Uid="116" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_117" Uid="117" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_118" Uid="118" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_119" Uid="119" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_120" Uid="120" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_121" Uid="121" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_122" Uid="122" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_123" Uid="123" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_124" Uid="124" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_125" Uid="125" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_126" Uid="126" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_127" Uid="127" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_128" Uid="128" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_129" Uid="129" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_130" Uid="130" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_131" Uid="131" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_132" Uid="132" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_133" Uid="133" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_UI_134" Uid="134" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_OneDrive_29" Uid="29" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_55" Uid="55" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_56" Uid="56" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_57" Uid="57" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_58" Uid="58" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_59" Uid="59" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_60" Uid="60" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_61" Uid="61" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_62" Uid="62" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_63" Uid="63" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_64" Uid="64" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_65" Uid="65" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_66" Uid="66" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_67" Uid="67" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_68" Uid="68" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_69" Uid="69" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_70" Uid="70" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_71" Uid="71" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_72" Uid="72" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_73" Uid="73" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_74" Uid="74" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_75" Uid="75" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_76" Uid="76" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_77" Uid="77" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_78" Uid="78" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_79" Uid="79" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_80" Uid="80" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_81" Uid="81" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_82" Uid="82" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_83" Uid="83" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_84" Uid="84" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_85" Uid="85" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_86" Uid="86" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_87" Uid="87" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_88" Uid="88" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_89" Uid="89" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_90" Uid="90" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_91" Uid="91" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_92" Uid="92" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_93" Uid="93" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_94" Uid="94" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_95" Uid="95" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_96" Uid="96" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_System_97" Uid="97" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_StartMenu_50" Uid="50" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_StartMenu_51" Uid="51" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_StartMenu_52" Uid="52" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_StartMenu_53" Uid="53" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_StartMenu_54" Uid="54" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Edge_17" Uid="17" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Edge_18" Uid="18" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Edge_19" Uid="19" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_Edge_20" Uid="20" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                    ...
                    <StackPanel Name="PanelToggle_Uwp" Visibility="Collapsed">
                    ...
                    <StackPanel Name="PanelToggle_Game" Visibility="Collapsed">

                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    <ToggleButton Name="Toggle_WindowsGameRecording_1135" Uid="1135" Style="{StaticResource ToggleSwitchLeftStyle}" IsChecked="False"/>
                                    <TextBlock Name="Text_WindowsGameRecording_135" Uid="135" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                                                    <DataTrigger Binding="{Binding ElementName=Toggle_WindowsGameRecording_1135, Path=IsChecked}" Value="True">
                                                        <Setter Property="Foreground" Value="#3F51B5"/>
                                                    </DataTrigger>
                                                </Style.Triggers>
                                            </Style>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_WindowsGameRecording_136" Uid="136" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_WindowsGameRecording_137" Uid="137" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_WindowsGameRecording_138" Uid="138" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                    ...
                    <StackPanel Name="PanelToggle_Tasks" Visibility="Collapsed">

                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    <ToggleButton Name="Toggle_ScheduledTasks_1047" Uid="1047" Style="{StaticResource ToggleSwitchLeftStyle}" IsChecked="False"/>
                                    <TextBlock Name="Text_ScheduledTasks_47" Uid="47" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ScheduledTasks_48" Uid="48" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ScheduledTasks_49" Uid="49" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                    ...
                    <StackPanel Name="PanelToggle_Defender" Visibility="Collapsed">

                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    <ToggleButton Name="Toggle_MicrosoftDefender_1021" Uid="1021" Style="{StaticResource ToggleSwitchLeftStyle}" IsChecked="False"/>
                                    <TextBlock Name="Text_MicrosoftDefender_21" Uid="21" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_MicrosoftDefender_22" Uid="22" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_MicrosoftDefender_23" Uid="23" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_MicrosoftDefender_24" Uid="24" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_MicrosoftDefender_25" Uid="25" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_MicrosoftDefender_26" Uid="26" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_MicrosoftDefender_27" Uid="27" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_MicrosoftDefender_28" Uid="28" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_0" Uid="0" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_1" Uid="1" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_2" Uid="2" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_3" Uid="3" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_4" Uid="4" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_5" Uid="5" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_6" Uid="6" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_7" Uid="7" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_8" Uid="8" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_9" Uid="9" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_10" Uid="10" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_11" Uid="11" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_12" Uid="12" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_13" Uid="13" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_14" Uid="14" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_15" Uid="15" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
                        ...
                        <Border Style="{StaticResource ToggleBorder}">
                            <DockPanel Margin="0 10 0 10">
                                <Grid HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Name="Text_ContextMenu_16" Uid="16" Text="" Margin="65 0 10 0" VerticalAlignment="Center" IsHitTestVisible="False">
                                        <TextBlock.Style>
                                            <Style TargetType="{x:Type TextBlock}">
                                                <Style.Triggers>
...
function Set-GuiLanguage {
	...
	#region Set Save Load Apply Buttons
