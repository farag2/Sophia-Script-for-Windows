...
New-Item -Path "Sophia_Script\Sophia_Script_for_Windows_11_Arm_v$Latest_Release_Windows_11_Arm_PowerShell_5_1\Module\Binaries" -ItemType Directory -Force
...
$Parameters = @{
	...
	Destination = "Sophia_Script\Sophia_Script_for_Windows_11_Arm_v$Latest_Release_Windows_11_Arm_PowerShell_5_1\Module\Binaries"
	Recurse     = $true
	Force       = $true
}
